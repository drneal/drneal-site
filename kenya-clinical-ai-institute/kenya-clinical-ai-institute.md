...
- **Standard setting by a formal method** — a modified Angoff panel of practising clinicians for knowledge assessments, borderline regression for performance assessments. Never an arbitrary 50%, and never a pass rate decided in advance.
