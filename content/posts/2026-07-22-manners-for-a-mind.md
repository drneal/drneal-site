...
series_index: 6
companion: 2026-07-11-from-predictor-to-assistant
---
...
<svg viewBox="0 0 720 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Two overlapping objectives: continue the text versus help the person">
  ...
  <text x="272" y="150" text-anchor="middle" fill="#d8f6fd" font-family="sans-serif" font-size="12" font-weight="bold">continue</text>
  <text x="272" y="168" text-anchor="middle" fill="#9fdcec" font-family="sans-serif" font-size="10.5">the text</text>
  <text x="272" y="200" text-anchor="middle" fill="#9fdcec" font-family="sans-serif" font-size="9.5">(what pretraining</text>
  <text x="272" y="214" text-anchor="middle" fill="#9fdcec" font-family="sans-serif" font-size="9.5">optimised)</text>

  <text x="448" y="150" text-anchor="middle" fill="#d3f5e6" font-family="sans-serif" font-size="12" font-weight="bold">help the</text>
  <text x="448" y="168" text-anchor="middle" fill="#8fd8b8" font-family="sans-serif" font-size="10.5">person</text>
  <text x="448" y="200" text-anchor="middle" fill="#8fd8b8" font-family="sans-serif" font-size="9.5">(what we actually</text>
  <text x="448" y="214" text-anchor="middle" fill="#8fd8b8" font-family="sans-serif" font-size="9.5">want)</text>
