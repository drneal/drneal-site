...
Current systems are making partial progress on all three fronts. Models with tool use and [retrieval-augmented generation](/post/2026-07-11-meaning-as-geometry) are extending effective memory. Agents operating in multi-step environments are demonstrating limited causal reasoning. Curriculum learning approaches are reducing catastrophic forgetting. None of this, individually, constitutes AGI. But the rate of progress on each component is considerably faster than it was five years ago.
...
Geoffrey Hinton, whose [backpropagation](/post/2026-08-12-backpropagation-by-hand) work in the 1980s created the foundations of modern deep learning and who shared the 2024 Nobel Prize in Physics for related contributions, told Nick Bostrom in 2015 that he expected political systems to use machine intelligence to "terrorize people." When Bostrom asked why he was doing the research anyway, Hinton replied: "The truth is that the prospect of discovery is too sweet." Mallaby structures his entire book around this confession.
