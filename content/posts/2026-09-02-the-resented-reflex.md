...
<div class="rr-note">
<strong>A note on the blinding, because the paper under-claims it.</strong> The trial describes itself as <em>single-blind</em>, on the grounds that allocation was known only to the study administrator. But two parties were blinded, not one: participants were blinded to the study&#39;s aims and to their own allocation &mdash; the seeded-error cases were randomly positioned precisely so that allocation could not be inferred from a pattern &mdash; and the three scoring physicians were blinded to group assignment, with identifying metadata stripped from the responses. Participants plus outcome assessors is conventionally <em>double</em>-blind; holding the allocation centrally is true of every blinded trial and is not normally what the term counts. This matters only in that both plausible directions of residual bias here are conservative. Unblinded graders could have inflated the difference; blinded graders with a Krippendorff&#39;s &alpha; of 0.93 could not have done so systematically. And a physician who knew they were in the seeded-error arm would have been vigilant in a way that <em>shrank</em> the effect. The design is, if anything, biased against the result it found.
</div>
