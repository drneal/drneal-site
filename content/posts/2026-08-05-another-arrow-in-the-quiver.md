---
title: "Another Arrow in the Quiver: The Clinical AI Institute Kenya Should Build"
date: 2026-08-05
...
.kcai-fig { margin: 2em 0 2.4em; }
.kcai-fig img {
  display: block; width: 100%; height: auto;
  border-radius: 8px; box-shadow: 0 2px 12px rgba(0,0,0,0.35);
}
.kcai-fig figcaption {
  font-size: 0.82em; color: #6b82a0; margin-top: 0.7em;
...
<div class="kcai-key">
<strong>The whole argument in two sentences.</strong> A clinician who does not have that arrow is, in 2026, offering their patient a lower standard of care than they could. A clinician who has it but has never been taught to draw it properly is offering something worse than that: care that <em>appears</em> better and is not.
</div>
...
<div class="kcai-warn">
<strong>AI literacy and AI discernment are different capacities, and teaching the first does not produce the second.</strong> Literacy is knowing what the tool does. Discernment is the trained, effortful, resented reflex of checking it anyway when you are tired and the answer looks right. Teaching clinicians what AI can do, without simultaneously and rigorously training the reflex of doubt, produces a clinician who is more dangerous than the one you started with. It is the equivalent of teaching someone to place a central line without teaching them to recognise a pneumothorax.
</div>

The target is not maximal trust, and it is not minimal trust.

<figure class="kcai-fig">
  <a href="/static/img/kenya-clinical-ai/fig-08.png" target="_blank" rel="noopener"><img src="/static/img/kenya-clinical-ai/fig-08.png" alt="Calibrated trust — the inverted-U relationship between trust placed in AI and patient safety"></a>
  <figcaption>Under-trust is a real failure mode with a real cost. Over-trust is the one we are all currently walking towards. The narrow band between them is what has to be taught.</figcaption>
</figure>
...
<div class="kcai-key">
<strong>A country that trains its entire clinical workforce to a single, measured, published standard of AI competence will be the first country in the world to have done so.</strong> Every health system on earth is going to have to solve this problem. Kenya can solve it first, solve it in the open, and hand the solution to everybody else.
</div>
...
2. **Scepticism is trained explicitly, and it is assessed.** Not a lecture on limitations — a drilled reflex, like recognising a deteriorating patient.
3. **Nothing is taught that is not assessed, and nothing is assessed that was not taught.**
4. **Attendance certificates are abolished.** No award for having been present. This will make us unpopular and it is not negotiable.
5. **All teaching is case-based and Kenyan.** Not a single vignette involving insurance codes, drugs we cannot obtain, or investigations we do not have.
6. **Simulation before patients, always.** Uncontroversial for central lines. It should be uncontroversial here.
7. **The learner produces something.** A logbook, a critique, an evaluation, a taught session — read and countersigned by a named senior person.
8. **Interprofessional wherever the work is interprofessional.** Ward AI use is not a doctor problem or a nurse problem; the failure modes live in the handover between them.
9. **Faculty are certified, and their teaching is observed.**
10. **We measure at Kirkpatrick 3 and 4, or we admit we do not know.** Satisfaction scores are close to worthless.
...
<figure class="kcai-fig">
  <a href="/static/img/kenya-clinical-ai/fig-two-loops.png" target="_blank" rel="noopener"><img src="/static/img/kenya-clinical-ai/fig-two-loops.png" alt="The two loops — Delegation and Diligence forming an outer ring mapped to consent and audit, Description and Discernment forming an inner ring mapped to history and examination, both turning around a single clinical encounter"></a>
  <figcaption>The 4D AI Fluency Framework (Dakan &amp; Feller), re-instantiated inside the working life of a clinician. The outer loop turns once per encounter; the inner loop turns many times inside it. The failure the curriculum exists to prevent is running the inner loop without ever having closed the outer one.</figcaption>
</figure>
...
<figure class="kcai-fig">
  <a href="/static/img/kenya-clinical-ai/fig-03.png" target="_blank" rel="noopener"><img src="/static/img/kenya-clinical-ai/fig-03.png" alt="The curriculum matrix — five professional tracks against five gated levels"></a>
  <figcaption>Progression is gated, not automatic. Each level requires a passed assessment <em>and</em> a countersigned workplace logbook before the next may be attempted. There is no time-served route.</figcaption>
</figure>
...
<div class="kcai-callout">
<strong>Nothing is taught that is not measured; nothing is measured that does not change what is taught.</strong> An institution that measures without acting is performing audit theatre. An institution that acts without measuring is guessing.
</div>

<figure class="kcai-fig">
  <a href="/static/img/kenya-clinical-ai/fig-05.png" target="_blank" rel="noopener"><img src="/static/img/kenya-clinical-ai/fig-05.png" alt="The quality loop — eight stations from standard-setting through to public reporting"></a>
  <figcaption>Eight stations, owned by an office that does not report to the trainers.</figcaption>
</figure>
...
1. **No vendor funds curriculum development for content that concerns their own products.** Unrestricted educational grants declared publicly, with amounts.
...
4. **The teaching platform is model-agnostic by architecture**, so the Institute can never become dependent on a single supplier's continued goodwill.
...
<figure class="kcai-fig">
  <a href="/static/img/kenya-clinical-ai/fig-07.png" target="_blank" rel="noopener"><img src="/static/img/kenya-clinical-ai/fig-07.png" alt="Phased roadmap across thirty-six months, from founding to institutionalisation"></a>
  <figcaption>Headcount shown is the cumulative core establishment at the end of each phase.</figcaption>
</figure>
...
<div class="kcai-warn">
I would not proceed to Phase 2 without that evaluation. If the pilot shows the training does not change behaviour, the correct action is to redesign, not to scale. <strong>The commonest way these institutions fail is by scaling an unevaluated pilot because momentum demanded it.</strong>
</div>
...
5. At least one adequately-powered study, conducted here, has reported the effect of this training on a patient-relevant outcome — published whatever it found.
...
- **The AI Fluency Framework** — Dakan, R. and Feller, J. — [aifluencyframework.org](https://aifluencyframework.org/) and the [Practical Summary Document](https://ringling.libguides.com/ai/framework). Course series on [Anthropic Academy](https://anthropic.skilljar.com/): [AI Fluency: Framework &amp; Foundations](https://anthropic.skilljar.com/ai-fluency-framework-foundations), [Teaching AI Fluency](https://anthropic.skilljar.com/teaching-ai-fluency), [AI Fluency for pK–12 Educators](https://anthropic.skilljar.com/ai-fluency-for-pk12-educators), [AI Fluency for Students](https://anthropic.skilljar.com/ai-fluency-for-students), [Claude 101](https://anthropic.skilljar.com/claude-101).
- **Automation bias** — [*Automation Bias in Large Language Model–Assisted Diagnostic Reasoning among Physicians Trained in AI Literacy — A Randomized Clinical Trial*, NEJM AI, 2025](https://ai.nejm.org/doi/full/10.1056/AIoa2501001).
- **The Kenyan evidence** — [OpenAI and Penda Health, *Pioneering an AI clinical copilot*](https://openai.com/index/ai-clinical-copilot-penda-health/); the underlying study, [*AI-based Clinical Decision Support for Primary Care: A Real-World Study*](https://arxiv.org/pdf/2507.16947); and the critical reading in [STAT News](https://www.statnews.com/2025/10/01/penda-health-open-ai-safety-net-study-kenya-artificial-intelligence/).
- **Kenyan law and policy** — [Digital Health Act 2023](https://www.policyvault.africa/policy/digital-health-act-2023/); [CIPESA's analysis](https://cipesa.org/2024/05/does-kenyas-digital-health-act-mark-a-new-era-for-data-governance-and-regulation/); [Kenya National AI Strategy 2025–2030](https://oecd.ai/en/dashboards/policy-initiatives/kenya-artificial-intelligence-strategy-2025-2030).
- **CPD requirements** — [KMPDC CPD compliance](https://kmpdc.go.ke/cpd-compliance/); [Nursing Council of Kenya online services](https://osp.nckenya.com/).
- **Health workforce** — [*Investing in the health workforce in Kenya*](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9422806/); [WHO AFRO](https://www.afro.who.int/countries/kenya/news/kenya-strengthening-health-workforce).
- **AI competencies in medical education** — [AAMC, *Artificial Intelligence Competencies Across the Learning Continuum*](https://www.aamc.org/about-us/medical-education/ai-competencies); [WHO, *Ethics and governance of AI for health: guidance on large multi-modal models*](https://www.who.int/publications/b/70584).

The Clinical 4Ds are an adaptation of the AI Fluency Framework by Prof. Rick Dakan (Ringling College of Art and Design) and Prof. Joseph Feller (Cork University Business School, University College Cork), elaborated into an open course series in partnership with Anthropic PBC with support from Ireland's Higher Education Authority. The open course materials are released under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en); any curriculum derived from them carries that licence forward. The Practical Summary Document is separately released under [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/) and is cited rather than adapted.
